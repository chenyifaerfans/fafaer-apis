    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('desc', models.CharField(blank=True, default='', max_length=100, null=True, verbose_name='个性签名')),
                ...
                ('is_mp_user', models.IntegerField(choices=[(0, '否'), (1, '是')], default=0, verbose_name='是否是公众号用户')),
                ('update_time', models.DateTimeField(default=datetime.datetime.now, verbose_name='更新时间')),
                ('is_valid', models.IntegerField(choices=[(0, '无效'), (1, '有效')], default=1, verbose_name='账号是否有效')),
